const pages = {
    experience: {
      hero: {
        name: "Hi, I'm Michael.",
        title: 'Here are my most recent roles!',
      },
      list: [
        {
          id: 1,
          ...
          technologies: 'Kotlin, Jetpack Compose, MVVM, RESTful APIs, Retrofit',
        },
        {
          id: 2,
          title: 'Smart Display',
          ...
          technologies:
            'Kotlin, Java, Retrofit, Broadcast Receivers, Alexa Skills Kit, BLE, XML Views',
        },
      ],
    },
    projects: {
